...
export const MappersCardsCollection = (props:any) => {
  ...
  useEffect(()=>{
      ...
      axios.get(`https://apidash2.herokuapp.com/mappers/overview?maps=${props.filterCompletionSelection}&order=${props.filterOrderSelection}`) // Devuelve lista de mappers
          .then((result)=>{
            setMappers(result.data)
            setStatus('resolved')
          })
